        ...
        <>
            {/* <div className="flex justify-center items-center my-5 md:mx-auto mx-5 relative md:w-1/3 w-full">
                ...
                <input
                    type="text"
                    placeholder="Search...."
                    className="py-5 pl-[4rem] w-full  bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 "
                    value={searchQuery}
             ...
             {/* Centering container */}
                {/* {loading ? (
					...
					contractsForPage.reverse().map((item, index) => (
			...
			{loading ? (
				<>
				<Head>
						<title>Receiver contract is loading	</title> {/* Set the title for the page */}
					</Head>
				...
				<div className="grid grid-cols-1 lg:px-10 lg:grid-cols-3">
					<Head>
                    <title>Contract Receiver</title> {/* Set the title for the page */}
					</Head>
